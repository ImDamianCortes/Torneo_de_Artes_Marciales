...
document.getElementById("btnRegistrar").addEventListener("click", () => {
    ...
    //variables correspondientes a los valores del formulario
    ...
    if (raza.value && nombre.value && ki.value && imagenSrcBg){
        ...
        imagenSrcBg = previewElement.style.background = "";
        ki.value=""
        reloadTable();
    } else{
...
const reloadTable = () => {
    ...
    participantes.forEach((p, i) => {
        participantesTemplate.innerHTML += `
        <div class="participante px-3 pb-2" data-fighter="${p.getNombre()}">
    <div class="card">
